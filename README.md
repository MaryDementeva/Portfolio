...
Задание: На основе таблицы постов и оличества лайков определить какие факторы больше всего влияют на количество лайков: время суток публикации, день недели или промежуток между постами.
Основные этапы:
- собраны данные о количестве постов, даты и времени поста и лайков к ним;
- создана база данных PostgreSQL;
- написаны запросы, на основании полученных данных сделаны выводы.

Выполненное задание в [файле](SQL/VK_likes.sql).
