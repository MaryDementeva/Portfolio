...
Результат: Модель успешно вводится в заблуждение: исходное изображение с добавленным шумом стабильно классифицируется как целевой ложный класс с высокой уверенностью (>95%). Визуально изображение остаётся узнаваемым для человека.
